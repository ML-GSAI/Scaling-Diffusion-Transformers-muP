...
def load_models(args):
    ...
    ckpt_path = 'output/pretrained_models/vit-l-14-clip/ViT-L-14.pt'
    clip_model, _, transform = open_clip.create_model_and_transforms(clip_arch, pretrained=ckpt_path, device=DEVICE)
