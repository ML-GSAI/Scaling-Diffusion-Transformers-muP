...
def _get_coord_data(models, dataloader, optcls, config, nsteps=3,
    ...
    vae = AutoencoderKL.from_pretrained(config.vae_pretrained)
        ...
        for width, model in models.items():
            ...
            for batch_idx, batch in enumerate(dataloader, 1):
                ...
                if dict_in_out:
                    ...
                    data_info = batch[3]
                    if cuda:
                        z, y, y_mask, data_info = z.cuda(), y.cuda(), y_mask.cuda(), data_info
...
def get_coord_data(models, dataloader, config, optimizer='sgd', lr=None, mup=True,
    ...
    data = _get_coord_data(models, dataloader, optcls, config, **kwargs)
