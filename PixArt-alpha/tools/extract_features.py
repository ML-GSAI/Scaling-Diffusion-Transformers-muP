...
def extract_caption_t5():
    ...
    t5 = T5Embedder(device="cuda", local_cache=True, cache_dir=f'{args.pretrained_models_dir}', dir_or_name='t5-v1_1-xxl', model_max_length=120)
...
def get_args():
    ...
    parser.add_argument("--img_size", default=256, type=int, help="image scale for multi-scale feature extraction")
    parser.add_argument('--start_index', default=0, type=int)
    parser.add_argument('--end_index', default=10000000, type=int)
    
    parser.add_argument('--json_path', default='data/SA1B/data_info.json', type=str)
    parser.add_argument('--t5_save_root', default='data/SA1B/caption_feature_wmask', type=str)
    parser.add_argument('--vae_save_root', default='data/SA1B/img_vae_features', type=str)
    parser.add_argument('--dataset_root', default='data/SA1B', type=str)
