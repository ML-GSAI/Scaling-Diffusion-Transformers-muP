...
def parse_args():
    ...
    parser.add_argument("--config", type=str, default='configs/pixart_config/PixArt_xl2_img256_SAM.py', help="config")
    parser.add_argument('--work-dir', default='output/train_SAM_256', help='the dir to save logs and models')
    ...
    parser.add_argument(
        ...
        type=str,
        default="text2image-pretraining-SAM256",
        help=(
    ...
    parser.add_argument('--loglr', type=float, default=None)
...
if __name__ == '__main__':
    ...
    if args.loglr is not None:
        config.optimizer['lr'] = 2**args.loglr
